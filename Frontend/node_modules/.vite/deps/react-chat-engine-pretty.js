    ...
    value: function renderFormField() {
      ...
      if (isMulti) {
        if (delimiter2) {
          ...
          return React2.createElement("div", null, input2);
        }
      } else {
...
var useIsMobile = function useIsMobile2() {
  var _useState = (0, import_react12.useState)([0, 0]), size2 = _useState[0], setSize = _useState[1];
...
var OtherAvatars = function OtherAvatars2(props) {
  ...
  return import_react12.default.createElement("div", {
    style: props.style
  }, import_react12.default.createElement(Avatar, {
  ...
  }), memberTwo && import_react12.default.createElement(Avatar, {
    className: "ce-custom-header-avatar",
  ...
  }), memberThree && import_react12.default.createElement(Avatar, {
    className: "ce-custom-header-avatar",
...
var ChatHeader = function ChatHeader2(props) {
  var _useState = (0, import_react12.useState)(false), isFilePickerLoading = _useState[0], setFilePickerLoading = _useState[1];
  var _useState2 = (0, import_react12.useState)(false), isDeleteLoading = _useState2[0], setDeleteLoading = _useState2[1];
  ...
  return import_react12.default.createElement("div", {
    className: "ce-custom-chat-header",
    style: styles$1.chatHeader
  }, import_react12.default.createElement(OtherAvatars, {
    chat: props.chat,
  ...
  }, getChatTitle(props.chat, props.username)), import_react12.default.createElement("div", {
    className: "ce-custom-header-subtitle",
    style: styles$1.headerSubtitle
  }, otherMember.is_online ? "Online" : "Offline")), import_react12.default.createElement("div", {
    className: "ce-custom-header-icon-wrapper",
    style: styles$1.iconWrapper
  }, import_react12.default.createElement("form", {
    style: {
      display: "inline-block"
    }
  }, import_react12.default.createElement("label", {
    htmlFor: "ce-files-picker"
  }, isFilePickerLoading ? import_react12.default.createElement(LoadingOutlined_default, {
    style: {
      color: "rgb(153, 153, 153)"
    },
    className: "ce-custom-header-icon"
  }) : import_react12.default.createElement(PaperClipOutlined_default, {
  ...
  })), isDeleteLoading ? import_react12.default.createElement(LoadingOutlined_default, {
    style: {
      color: "rgb(153, 153, 153)"
    },
    className: "ce-custom-header-icon"
  }) : import_react12.default.createElement(DeleteFilled_default, {
    onClick: function onClick() {
      return onDelete();
    },
    className: "ce-custom-header-icon",
    style: styles$1.headerIcon
  })), import_react12.default.createElement("style", null, ".ce-custom-header-icon:hover { color: rgb(24, 144, 255) !important; }"));
};
var styles$1 = {
  chatAvatars: {
...
var ChatForm = function ChatForm2(props) {
  var didMountRef = (0, import_react12.useRef)(false);
  var _useState = (0, import_react12.useState)([]), options2 = _useState[0], setOptions = _useState[1];
  var _useState2 = (0, import_react12.useState)([]), selected = _useState2[0], setSelected = _useState2[1];
  ...
  }, import_react12.default.createElement(react_select_esm_default, {
    options: options2,
    autoFocus: true,
    isMulti: true,
  ...
  }, import_react12.default.createElement(PlusOutlined_default, null)), import_react12.default.createElement("style", null, ".ce-create-chat-button:hover { background-color: #40a9ff; }"));
};
var customStyles = {
...
var CustomChatCard = function CustomChatCard2(props) {
  var chat = props.chat;
  if (chat === void 0)
    return import_react12.default.createElement("div", null);
  ...
  return import_react12.default.createElement("div", null, import_react12.default.createElement("style", null, "\n        .ce-chat-card:hover { border: 1px solid #1890ff !important; box-shadow: rgb(24 144 255 / 35%) 0px 2px 7px !important; }\n        .ce-chat-card-loading { height: 10px !important; }\n        .ce-chat-card-title-loading { top: 16px !important; }\n        "), import_react12.default.createElement(ChatCard, {
    ...
    renderAvatar: function renderAvatar() {
      return import_react12.default.createElement(OtherAvatars, {
        chat,
        username: props.username,
        style: {
          position: "relative",
...
var MessageForm = function MessageForm2(props) {
  var _useState = (0, import_react12.useState)(""), text = _useState[0], setText = _useState[1];
  var _useState2 = (0, import_react12.useState)(false), isFocused = _useState2[0], setIsFocused = _useState2[1];
  ...
  return import_react12.default.createElement("form", {
    onSubmit,
  ...
  }), import_react12.default.createElement("style", null, ".ce-custom-message-input::placeholder { color: #e1e1e1; font-family: Avenir; }"), import_react12.default.createElement("button", {
    type: "submit",
    className: "ce-custom-send-button",
    style: _extends2({}, styles$3.sendButton)
  }, import_react12.default.createElement(CaretUpFilled_default, null)));
};
var styles$3 = {
  messageForm: {
    height: "68px",
...
var ChatListHeader = function ChatListHeader2(props) {
  ...
  }, "Chats"), import_react12.default.createElement("button", {
    className: "ce-new-chat-button",
    style: styles$4.chatListHeaderButton,
    onClick: props.onNewChatClick
  }, import_react12.default.createElement(FormOutlined_default, null)), import_react12.default.createElement("style", null, ".ce-new-chat-button:hover { color: rgb(24, 144, 255) !important; }"));
};
var styles$4 = {
  chatListHeader: {
    display: "inline-block",
...
var PrettyChatWindow = function PrettyChatWindow2(props) {
  var _useState = (0, import_react12.useState)(false), isChatFormActive = _useState[0], setIsChatFormActive = _useState[1];
  var _useState2 = (0, import_react12.useState)([]), chatFormUsers = _useState2[0], setChatFromUsers = _useState2[1];
  ...
  return import_react12.default.createElement("div", {
  ...
  }, import_react12.default.createElement(MultiChatSocket, Object.assign({}, chatProps)), import_react12.default.createElement("div", {
    style: styles$5.col1
  }), import_react12.default.createElement("div", {
    style: isMobile ? styles$5.col0 : styles$5.col8
  }, import_react12.default.createElement(ChatList, Object.assign({}, chatProps, {
    renderChatForm: function renderChatForm() {
      return import_react12.default.createElement(ChatListHeader, {
    ...
    renderChatCard: function renderChatCard(props2) {
      return import_react12.default.createElement(CustomChatCard, Object.assign({}, props2, {
  ...
  }, import_react12.default.createElement(ChatFeed, Object.assign({}, chatProps, {
    renderChatHeader: function renderChatHeader(chatHeaderProps) {
      if (isChatFormActive) {
        return import_react12.default.createElement(ChatForm, {
        ...
        return import_react12.default.createElement(ChatHeader, Object.assign({}, chatHeaderProps, {
          chat: chatProps.chat,
          projectId: chatProps.projectId,
          username: chatProps.username,
          secret: chatProps.secret,
    ...
    renderMessageList: function renderMessageList(props2) {
      return import_react12.default.createElement(MessageList, Object.assign({}, props2, {
